...
HD_PWD='C:/Users/meshi/SyncCounter/SyncCounter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log syncCnt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source syncCnt.tcl
