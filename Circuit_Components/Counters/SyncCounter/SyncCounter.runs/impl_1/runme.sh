...
HD_PWD='C:/Users/meshi/SyncCounter/SyncCounter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log syncCnt.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source syncCnt.tcl -notrace
