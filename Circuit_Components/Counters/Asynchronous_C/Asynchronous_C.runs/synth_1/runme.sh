...
HD_PWD='C:/Users/meshi/Asynchronous_C/Asynchronous_C.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Asyn_cntr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Asyn_cntr.tcl
