...
HD_PWD='C:/Users/meshi/Asynchronous_C/Asynchronous_C.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Asyn_cntr.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Asyn_cntr.tcl -notrace
